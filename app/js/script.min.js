        ...
        tels.forEach((tel)=>{
           // https://intl-tel-input.com/
            ...
            tel.addEventListener('keydown', function(e){
                ...
                let maskIdx = phoneInput.data('maskidx')
                let key = event.key
                if (/^[0-9]$/i.test(key) && /^[0-9]$/i.test(phoneInput.val()[phoneInput.val().length - 1]) && inputLength + 1 > mask && masks[countrycode].length > maskIdx + 1 && phoneInput.data('standalone') != true){
